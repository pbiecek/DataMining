...
library(irr)
kappa2(pima$test, predicted.pima)
```
# Other metrics
Sensitivity of a model measures the proportion of positive examples that were correctly classified.
...
# Class excercise
1. Use data `churn` from package `caret` or `C50`
2. Prepare data for classification (http://topepo.github.io/caret/pre-processing.html)
3. Examine various methods of splitting data to train and test sets (e.g. random samples, cross-validation, http://topepo.github.io/caret/data-splitting.html) - 1 group
4. Examine various methods of feature selection (http://topepo.github.io/caret/feature-selection-overview.html) - 1 group
