...
$$
BIC(M) = -2 * log-likelihood(M) + npar(M) * log(n)
$$

where $n$ is the number of observations, $npar(M)$ is the number of parameters in the model $M$ while $log-likelihood(M)$ it the model log likelihood. 
